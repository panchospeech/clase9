...
<p> Mi nombre es
	...
	tengo <?php print($arreglobjeto[edad]);?> años, mi signo es <?php print($arreglobjeto[signo]);?> y mi animal favorito es el <?php print($arreglobjeto[animal]);?>.
</p>
